            ...
            <div className="panel">
                <div className="panel-heading">
                    ...
                    <span className="panel-subtitle">
                        {' '}
                        {this.state.started == '(not-set)' ? this.props.started : this.state.started} - {this.state.finished == '(not-set)' ? this.props.finished : this.state.finished}
                    </span>

                    <div className="panel-action">
                        <a
                            onClick={() => {
                                this.props.removeEducation(this.props.id);
                                this.props.removeEducationJsx(this.props.id);
                            }}>
