        ...
        for (let index = 0; index < tempSkills.length; index++) {
            elements.push(
                <div key={index} className="skillItem">
                    ...
                    <div className="progressBar" style={{ borderColor: primaryColor }}>
                        <div
                            style={{
                                width: tempSkills[index].rating + '%',
                                backgroundColor: primaryColor,
                            }}
                            className="progressFilling"></div>
                    </div>
                </div>
            );
        }
            ...
            elements.push(
                <div key={index} className="employmentWrapper">
                    <div className="employment__head">
                        <span className="employment__jobTitle">
                            {tempEmployments[index].jobTitle}, {tempEmployments[index].employer}
                        </span>
                        <span>
                    ...
                    <div className="employment__body">
                        <div dangerouslySetInnerHTML={{ __html: tempEmployments[index].description }} />
                    </div>
                </div>
            );
        }
        ...
        for (let index = 0; index < tempEducations.length; index++) {
            elements.push(
                <div className="employmentWrapper">
                    <div className="employment__head">
                        <span className="employment__jobTitle">
                            {tempEducations[index].degree}, {tempEducations[index].school}
                        </span>
                        <span>
                    ...
                    <div className="employment__body">
                        <div dangerouslySetInnerHTML={{ __html: tempEducations[index].description }} />
                    </div>
                </div>
            );
        }
                ...
                <div className="cv-content">
                    ...
                    <div className="cv-head">
                        ...
                        <div className="cv__imageWrapper">
                            <div className="cv__image" style={{ borderColor: primaryColor }}>
                        ...
                        <div className="cv__bodyLeft">
                            ...
                            <div className="cv__leftSecton">
                                <div className="sectionTitle">
                                    <h1>{t('resume.info')}</h1>
                                    <div style={{ width: '20%', backgroundColor: primaryColor }} className="sectionTitle__underLine"></div>
                                    {/* details */}
                        ...
                        <div className="bodyRight">
                            ...
                            <div className="rightSection">
                                <div className="sectionTitle">
                                    ...
                                    <div style={{ textAlign: 'justify' }} dangerouslySetInnerHTML={{ __html: this.props.values.summary }} />
                                </div>
                            </div>{' '}
                            {/* End   Summary*/}
