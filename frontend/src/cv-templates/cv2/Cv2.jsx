...
class Cv2 extends Component {
    ...
    // Get primary color from props or default to original yellow
    getPrimaryColor() {
        return this.props.values?.colors?.primary || '#f0c30e';
    }
                ...
                <div key={index} className="skill">
                    ...
                    <div className="rating">
                        {this.props.values.skills[index].rating > 70 ? (
                            <>
                                <div className="bullet" style={{ backgroundColor: primaryColor }}></div>
                                <div className="bullet" style={{ backgroundColor: primaryColor }}></div>
                                <div className="bullet" style={{ backgroundColor: primaryColor }}></div>
                                <div className="bullet" style={{ backgroundColor: primaryColor }}></div>
                                <div className="bullet" style={{ backgroundColor: primaryColor }}></div>
            ...
            elements.push(
                <div key={index} className="cv-sectionRightExperience">
                    ...
                    <div className="cv-jobDetailsRight">
                        ...
                        <div className="cv-jobDescription" dangerouslySetInnerHTML={{ __html: this.props.values.employments[index].description }} />
                    </div>
                </div>
            );
        }
            ...
            elements.push(
                <div key={index} className="cv-sectionRightExperience">
                    ...
                    <div className="cv-jobDetailsRight">
                        ...
                        <div className="cv-jobDescription" dangerouslySetInnerHTML={{ __html: this.props.values.educations[index].description }} />
                    </div>
                </div>
            );
        }
            ...
            <div id="resumen" className="cv2-board">
                <div className="cv2-content">
                    ...
                    <div className="cv2-head">
                        <div className="cv-headCircle" style={{ backgroundColor: primaryColor }}></div>
                    ...
                    <div className="cv2-body">
                        ...
                        <div className="cv-bodySection">
                            <div className="cv-sectionLeft"></div>
                                ...
                                <div className="cv-contactDetails">
                                    <div className="cv-contactItem">
                                        ...
                                        <div className="cv-contactItemDetails">
                                            <div className="cv-contactItemHead">{t('resume.phone')}</div>
                                            <div className="cv-contactItemValue">{this.props.values.phone}</div>
                                        </div>
                                    </div>
                                    {/* Contact Item */}
                                    <div className="cv-contactItem">
                                        ...
                                        <div className="cv-contactItemDetails">
                                            <div className="cv-contactItemHead">{t('resume.email')}</div>
                                            <div className="cv-contactItemValue">{this.props.values.email}</div>
                                        </div>
                                    </div>
                                    {/* Contact Item */}
                                    <div className="cv-contactItem">
                                        ...
                                        <div className="cv-contactItemDetails">
                                            <div className="cv-contactItemHead">{t('resume.address')}</div>
                        ...
                        {/* bodySection */}
                        <div className="cv-bodySection">
                            <div className="cv-sectionLeft">{t('resume.personalSummary')}</div>
                            <div className="cv-sectionRight">
                                {/* Summary */}
                                <div className="summary" dangerouslySetInnerHTML={{ __html: this.props.values.summary }} />
                            </div>{' '}
                            {/* End Section Right */}
                        </div>{' '}
                        {/* End bodySection */}
                        ...
                        {/* bodySection */}
                        <div className="cv-bodySection">
                            <div className="cv-sectionLeft">{t('resume.educationHistory')}</div>
                            <div className="cv-sectionRight">
                                {/* Educations  */}
                        ...
                        {/* bodySection */}
                        <div className="cv-bodySection">
                            <div className="cv-sectionLeft">{t('resume.skills')}</div>
                            <div className="cv-sectionRight">
                                {/* Skills */}
                                <div className="skills">{this.returnSkills()}</div>
                            </div>{' '}
                            {/* End Section Right */}
                        </div>{' '}
                        {/* End bodySection */}
