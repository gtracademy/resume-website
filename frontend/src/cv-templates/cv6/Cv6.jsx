...
class Cv6 extends Component {
    ...
    getPrimaryColor() {
        return this.props.values?.colors?.primary || '#7c3aed';
    }

    getSecondaryColor() {
        return this.props.values?.colors?.secondary || '#09043c';
    }
        ...
        return (
            <div id="resumen" className="cv6-board">
                ...
                <div className="cv6-content">
                    <div className="cv6-left" style={{ backgroundColor: this.getSecondaryColor() }}>
                        {/* Photo */}
                        <div className="cv6-photo">{this.props.values.photo !== null ? <img className="photo" src={this.props.values.photo} /> : 'photo'}</div>
                        {/* Contact Details */}
